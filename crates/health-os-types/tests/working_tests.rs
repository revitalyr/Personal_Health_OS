// Working Tests for Health OS Semantic Types
// Simplified tests that focus on core functionality without compilation issues
...
mod allergy_tests {
    ...
    #[test]
    fn test_allergy_reaction_and_notes() {
        let patient_id = PatientId::new_v4();
        ...
        // Set notes
        assert!(allergy.set_notes("Avoid latex products").is_ok());
